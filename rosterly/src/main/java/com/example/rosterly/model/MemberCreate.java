...
public class MemberCreate {
   ...
   */
  public MemberCreate(String name, String email, RoleEnum role, Integer companyId, LocalDate joinDate) {
    this.name = name;
    this.email = email;
    this.role = role;
  ...
  public MemberCreate phone(String phone) {
    this.phone = phone;
    return this;
  }
  ...
  public MemberCreate role(RoleEnum role) {
    this.role = role;
    return this;
  }
  ...
  public MemberCreate companyId(Integer companyId) {
    this.companyId = companyId;
    return this;
  }
  ...
  public MemberCreate projectId(Integer projectId) {
  ...
  public MemberCreate joinDate(LocalDate joinDate) {
    this.joinDate = joinDate;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.name, memberCreate.name) &&
        Objects.equals(this.email, memberCreate.email) &&
        Objects.equals(this.phone, memberCreate.phone) &&
        Objects.equals(this.role, memberCreate.role) &&
        Objects.equals(this.companyId, memberCreate.companyId) &&
        Objects.equals(this.projectId, memberCreate.projectId) &&
        Objects.equals(this.joinDate, memberCreate.joinDate);
  }

  @Override
  public int hashCode() {
    return Objects.hash(name, email, phone, role, companyId, projectId, joinDate);
  }
